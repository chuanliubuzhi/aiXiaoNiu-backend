<template>
	...
	<div class="container newcon">
		<div class="ui-box">
			<el-table border ref="multipleTable" :data="forsaleGoods" tooltip-effect="dark" style="width: 100%" >
			...
			fetchData() {
		    	let search = {
		      	...
		      	goodsIndex(search).then(response => {
		      		...
		      		this.forsaleGoods = response.data.data ;
			        for (let i = 0; i < this.forsaleGoods.length; i++) {
						this.forsaleGoods[i].last_update = toDate(this.forsaleGoods[i].last_update);
					}
